    ...
    const renderDetailView = () => {
        ...
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <div className="fixed top-[76px] md:top-[48px] left-0 right-0 z-40 w-full bg-gray-100/95 dark:bg-gray-950/90 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800 shadow-sm">
